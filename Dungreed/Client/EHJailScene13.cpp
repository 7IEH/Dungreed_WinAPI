...
namespace EH
{
	void JailScene13::Initialize()
	{
		...
		banshee1->GetComponent<Transform>()->SetPos(Math::Vector2<float>(796.f, 256.f));
		...
		warrior1->GetComponent<Transform>()->SetPos(Math::Vector2<float>(400.f, 540.f));
		...
		warrior2->GetComponent<Transform>()->SetPos(Math::Vector2<float>(788.f, 540.f));
		...
		archor1->GetComponent<Transform>()->SetPos(Math::Vector2<float>(1536.f, 316.f));
		...
		archor2->GetComponent<Transform>()->SetPos(Math::Vector2<float>(1536.f, 956.f));
