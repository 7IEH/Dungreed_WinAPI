...
namespace EH
{
    ...
    void TownScene::Initialize()
    {
        ...
        temp = Resources::Load<Image>(L"Sky", L"..\\Resources\\TownScene\\Sky_Day.png");
        ...
        temp = Resources::Load<Image>(L"Back", L"..\\Resources\\TownScene\\TownBG_Day.png");
        ...
        temp = Resources::Load<Image>(L"TownTree", L"..\\Resources\\TownScene\\TownLayer_Day.png");
        ...
        temp = Resources::Load<Image>(L"HPBack", L"..\\Resources\\UI\\PlayerLifeBack.png");
        ...
        temp = Resources::Load<Image>(L"HPBase", L"..\\Resources\\UI\\PlayerLifeBase 1.png");
        ...
        temp = Resources::Load<Image>(L"DashBase", L"..\\Resources\\UI\\DashCountBase.png");
        ...
        temp = Resources::Load<Image>(L"CoinUI", L"..\\Resources\\UI\\Coin.png");
        ...
        temp = Resources::Load<Image>(L"FoodUI", L"..\\Resources\\UI\\Food.png");
        ...
        temp = Resources::Load<Image>(L"WeaponSlot", L"..\\Resources\\UI\\EquippedWeaponBase.png");
        ...
        temp = Resources::Load<Image>(L"TownFloor", L"..\\Resources\\TownScene\\Map.png");
        ...
        temp = Resources::Load<Image>(L"FloorUnder", L"..\\Resources\\TownScene\\Map2.png");
        ...
        temp = Resources::Load<Image>(L"player", L"..\\Resources\\Player\\Basic\\Idle\\CharIdle0.png");
