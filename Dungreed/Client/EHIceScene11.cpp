...
namespace EH
{
	void IceScene11::Initialize()
	{
        ...
        texture = Resources::Load<Texture>(L"IceBG11", L"..\\Resources\\Dungeon\\IceBackGround\\11\\IceScene11.bmp");
        IceBG1->GetComponent<SpriteRenderer>()->SetImg(texture);
        IceBG1->GetComponent<SpriteRenderer>()->SetAffectCamera(true);  
	}

	void IceScene11::Update()
	{
		Scene::Update();
	}

	void IceScene11::Render(HDC hdc)
	{
		Scene::Render(hdc);
	}
}