...
namespace EH
{
	void IceScene18::Initialize()
	{
        ...
        SetSize(Math::Vector2<float>(3136.f, 720.f));
        ...
        IceBG1->GetComponent<Transform>()->SetPos(Math::Vector2<float>(1568.f, 360.f));
        IceBG1->GetComponent<Transform>()->SetScale(Math::Vector2<float>(3136.f, 720.f));
        texture = Resources::Load<Texture>(L"IceBG18", L"..\\Resources\\Dungeon\\IceBackGround\\18\\IceScene18.bmp");
