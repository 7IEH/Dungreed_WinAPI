...
namespace EH
{
	void IceScene16::Initialize()
	{
        ...
        texture = Resources::Load<Texture>(L"IceBG16", L"..\\Resources\\Dungeon\\IceBackGround\\16\\IceScene16.bmp");
        IceBG1->GetComponent<SpriteRenderer>()->SetImg(texture);
        IceBG1->GetComponent<SpriteRenderer>()->SetAffectCamera(true); 
	}

	void IceScene16::Update()
	{
		Scene::Update();
	}

	void IceScene16::Render(HDC hdc)
	{
		Scene::Render(hdc);
	}
}
