...
namespace EH
{
    ...
    void SelectScene::Initialize()
    {
		...
		Slot1->GetComponent<Transform>()->SetPos(Math::Vector2<float>(50.f, 135.f));
		...
		Slot2->GetComponent<Transform>()->SetPos(Math::Vector2<float>(450.f, 135.f));
		...
		Slot3->GetComponent<Transform>()->SetPos(Math::Vector2<float>(850.f, 135.f));
		...
		Slot1Text->GetComponent<Transform>()->SetPos(Math::Vector2<float>(172.f, 180.f));
		...
		Slot2Text->GetComponent<Transform>()->SetPos(Math::Vector2<float>(572.f, 180.f));
		...
		Slot3Text->GetComponent<Transform>()->SetPos(Math::Vector2<float>(972.f, 180.f));
		...
		Slot1Delete->GetComponent<Transform>()->SetPos(Math::Vector2<float>(116.f, 610.f));
		...
		Slot2Delete->GetComponent<Transform>()->SetPos(Math::Vector2<float>(510.f, 610.f));
		...
		Slot3Delete->GetComponent<Transform>()->SetPos(Math::Vector2<float>(916.f, 610.f));
		...
		Exit->GetComponent<Transform>()->SetPos(Math::Vector2<float>(1185.f, 32.f));
