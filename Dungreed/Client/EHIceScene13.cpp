...
namespace EH
{
	void IceScene13::Initialize()
	{
        ...
        texture = Resources::Load<Texture>(L"IceBG13", L"..\\Resources\\Dungeon\\IceBackGround\\13\\IceScene13.bmp");
        IceBG1->GetComponent<SpriteRenderer>()->SetImg(texture);
        IceBG1->GetComponent<SpriteRenderer>()->SetAffectCamera(true);
	}

	void IceScene13::Update()
	{
		Scene::Update();
	}

	void IceScene13::Render(HDC hdc)
	{
		Scene::Render(hdc);
	}
}